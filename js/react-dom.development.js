...
(function (global, factory) {
  ...
  var TOP_CAN_PLAY_THROUGH =
    unsafeCastStringToDOMTopLevelType("canplaythrough");
  ...
  var TOP_GOT_POINTER_CAPTURE =
    unsafeCastStringToDOMTopLevelType("gotpointercapture");
  ...
  var TOP_LOST_POINTER_CAPTURE =
    unsafeCastStringToDOMTopLevelType("lostpointercapture");
  ...
  var TOP_SELECTION_CHANGE =
    unsafeCastStringToDOMTopLevelType("selectionchange");
  ...
  function createElement(type, props, rootContainerElement, parentNamespace) {
    ...
    if (namespaceURI === HTML_NAMESPACE) {
      ...
      if (type === "script") {
        ...
        // $FlowIssue `createElement` should be updated for Web 03_components
    ...
    if (current$$1 === null) {
      ...
      if (prevDidTimeout) {
        ...
        if (nextDidTimeout) {
          ...
          // working on.
          var _fallbackChildFragment = (_primaryChildFragment.sibling =
        ...
        if (nextDidTimeout) {
          ...
          var _fallbackChildFragment2 = (_primaryChildFragment2.sibling =
  ...
  function commitRoot(root, finishedWork) {
    ...
    if (firstEffect !== null && rootWithPendingPassiveEffects !== null) {
      ...
      passiveEffectCallbackHandle = unstable_runWithPriority(
  ...
  function computeExpirationForFiber(currentTime, fiber) {
    ...
    if (
      priorityLevel === unstable_UserBlockingPriority &&
